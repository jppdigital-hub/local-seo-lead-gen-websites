...
export const siteConfig = {
  ...
  siteDescription:
    "We help Chattanooga residents find licensed, insured junk removal professionals in their area. Submit your job details and a local pro will contact you with a free quote — usually within the hour.",
  ...
  howItWorks: [
    ...
    {
      step: "3",
      title: "Get a Free Quote & Schedule",
      desc: "The pro contacts you directly — usually within the hour — with an upfront price. No obligation until you agree.",
    },
  ],
  ...
  services: [
    {
      ...
      longDesc:
        "Furniture removal is one of the most common junk removal jobs in Chattanooga. Whether you're moving, downsizing, or clearing out a rental, local junk removal pros handle any furniture — no disassembly required on your part. They load, haul, and dispose of or donate items wherever possible.",
      whatToExpect:
        "A typical furniture pickup takes 30–60 minutes. The crew handles all loading. Most pros recycle or donate usable pieces to local Chattanooga thrift stores and nonprofits. Expect to pay by volume (truckload fractions) rather than per item.",
      avgCost: "$75 – $250 depending on quantity and access",
      icon: "🛋️",
      tips: [
        "Have items near the door or in the driveway if possible — saves time and may lower cost",
        "Mention any tight stairwells or elevator-only buildings when you request a quote",
        "Ask the pro whether your items qualify for donation — reduces landfill and sometimes reduces your price",
      ],
    },
    {
      slug: "appliance-removal",
      name: "Appliance Removal",
      shortDesc: "Refrigerators, washers, dryers, AC units — proper disposal.",
      longDesc:
      ...
      whatToExpect:
        "Appliance jobs are typically quick — 20 to 45 minutes. Pros bring the right equipment for heavy items. Refrigerators containing Freon must be disposed of at a certified facility; a reputable Chattanooga pro will handle this for you.",
      avgCost: "$85 – $175 per appliance depending on type and size",
      icon: "🧺",
      tips: [
    ...
    },
    {
      ...
      avgCost: "$95 – $350 depending on volume",
      icon: "🌿",
      tips: [
        "Bundle branches under 4 feet if possible to speed up loading",
        "Pile debris in an accessible location — driveway or curb is ideal",
    ...
    },
    {
      ...
      avgCost: "$125 – $500+ depending on volume and material type",
      icon: "🔨",
      tips: [
        "Separate heavy materials (concrete, tile) from light debris — pros may price these differently",
        "Drywall and gypsum have special disposal requirements in Tennessee — ask the pro how they handle it",
    ...
    },
    {
      ...
      whatToExpect:
        "Estate cleanouts are usually priced by truckload or by the day for large jobs. Most crews include sorting — they won't just bulldoze everything. Expect multiple trucks and a full crew for a whole-house cleanout. Ask about donation receipts for tax purposes.",
      avgCost: "$300 – $1,500+ depending on home size and volume",
      icon: "🏠",
      tips: [
        "Walk through the property first and tag items to keep before the crew arrives",
        "Ask whether the pro partners with local donation centers — Chattanooga has several that accept estate items",
    ...
    },
    {
      ...
      longDesc:
        "Hot tub removal is a specialty job that most homeowners cannot do themselves. A standard hot tub weighs 400–800 lbs empty and cannot be moved in one piece. It needs to be drained, disconnected from electrical (a licensed electrician may need to disconnect the breaker first), cut apart with a reciprocating saw, and hauled in sections. Local Chattanooga pros who handle hot tub removal have the tools, the muscle, and the disposal connections to do it correctly.",
      whatToExpect:
        "Plan for 2–4 hours for a standard hot tub removal. The crew will cut the tub into manageable sections and haul all foam, fiberglass, and hardware. You'll need to have the electrical disconnected at the breaker before they arrive. The space will be cleared and swept when they leave.",
      avgCost: "$250 – $450 for most standard hot tubs",
      icon: "🛁",
      tips: [
        "Have an electrician disconnect the power before the pro arrives — this is a safety requirement",
        "Drain the hot tub at least a day before the scheduled pickup",
        "Clear the access path — the crew needs to get equipment in and debris out",
      ],
    },
  ],
  ...
  trustPoints: [
    "Pros are licensed & insured in Tennessee",
    "Same-day and next-day availability",
    "Free quotes — no obligation",
    "Pros recycle & donate when possible",
    "Serving all of Hamilton County",
    "Connecting Chattanooga residents since 2018",
  ],

  // --- FAQ ---
  faqs: [
    {
      q: "How does this work — are you the junk removal company?",
      a: "No. ChattanoogaJunkRemoval.com is a free referral service. You describe your job, and we connect you with a licensed, insured local junk removal professional who serves your area. The pro contacts you directly with a free quote. You decide whether to book — no pressure.",
    },
    {
      q: "How much does junk removal cost in Chattanooga?",
      a: "Most residential junk removal jobs in Chattanooga range from $75 to $500 depending on volume. Pricing is typically by the truckload or fraction thereof. Single-item pickups (one sofa, one appliance) start around $75–$100. Full truckloads run $350–$500. The pro will give you an exact price before any work starts.",
    },
    {
      q: "How quickly will a pro contact me?",
      a: "During business hours (Mon–Sat, 7am–6pm), most pros respond within 1–2 hours. For urgent same-day jobs, call the number on this site and we'll get you connected immediately.",
    },
    {
      q: "What items can junk removal pros handle?",
      a: "Most pros handle furniture, appliances, electronics, yard waste, construction debris, mattresses, hot tubs, and general household clutter. They cannot haul hazardous materials — paint, chemicals, asbestos, medical waste, or motor oil. Everything else is generally fine.",
    },
    {
    ...
    },
    {
      ...
      a: "No. Submitting a request and getting connected to a local pro is completely free. The pro charges for the actual junk removal work — we don't add any fees.",
    },
  ],
  ...
  // --- Stats (about the local market / directory activity) ---
  stats: {
    prosInNetwork: "8",
    areasServed: "12",
